...
class Motor:
    ...
    def set_profile(self, acc, vel):
        self.packet_handler.write4ByteTxRx(self.port_handler, self.id, self.addr_profile_acc, acc)
        self.packet_handler.write4ByteTxRx(self.port_handler, self.id, self.addr_profile_vel, vel)
    ...
    def pos_model(self):
        self.torq_off()
        # 位置模式
        self.packet_handler.write1ByteTxRx(self.port_handler, self.id, self.addr_operating_mode, self.extpos_operating_mode)
        self.torq_on()
    ...
    def set_pos_pid(self, kp, ki, kd):
        self.packet_handler.write2ByteTxRx(self.port_handler, self.id, self.addr_pos_p, kp) 
        self.packet_handler.write2ByteTxRx(self.port_handler, self.id, self.addr_pos_i, ki) 
        self.packet_handler.write2ByteTxRx(self.port_handler, self.id, self.addr_pos_d, kd) 
